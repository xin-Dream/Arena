...
void Attack_Defend(void)
{
	...
	else if(Len_Front_Left >cheju&&Len_Front_Right<1000)//如果左前方有敌人且右前方没有
	{
		Turn_to(20);
		while(Gray_Left>1200&&Gray_Mid>1200&&Gray_Right>1200)
		{
	...
	else if(Len_Front_Right >cheju&&Len_Front_Left<1000)//如果右前方有敌人且左前方没有
	{
		Turn_to(-20);
		while(Gray_Left>1200&&Gray_Mid>1200&&Gray_Right>1200)
		{
	...
	else if(Len_Left>cheju)//如果左侧有敌人
	{
		Turn_to(90);
		while(Gray_Left>1200&&Gray_Mid>1200&&Gray_Right>1200)
		{
	...
	else if(Len_Right>cheju)//如果右侧有敌人
	{
		Turn_to(-90);
		while(Gray_Left>1200&&Gray_Mid>1200&&Gray_Right>1200)
		{
	...
	else if(Len_Back>cheju)//如果后方有敌人
	{
//		Set_Speed(80,80);
//	    delay_ms(100);
//		Set_Speed(0,0);
