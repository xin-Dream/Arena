...
//IO方向设置
#define VL_SDA_IN()  {GPIOB->CRH&=0XFF0FFFFF;GPIOB->CRH|=8<<20;}
#define VL_SDA_OUT() {GPIOB->CRH&=0XFF0FFFFF;GPIOB->CRH|=3<<20;}


//IO操作函数
#define VL_IIC_SCL    PBout(12) 		//SCL
#define VL_IIC_SDA    PBout(13) 		//SDA	 
#define VL_READ_SDA   PBin(13) 		    //输入SDA 
