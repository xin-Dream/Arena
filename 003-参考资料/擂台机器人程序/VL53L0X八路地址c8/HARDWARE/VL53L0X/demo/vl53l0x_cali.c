...
_vl53l0x_adjust1 Vl53l0x_adjust1; 
_vl53l0x_adjust2 Vl53l0x_adjust2; 
_vl53l0x_adjust3 Vl53l0x_adjust3; 
_vl53l0x_adjust4 Vl53l0x_adjust4; 
_vl53l0x_adjust5 Vl53l0x_adjust5; 
_vl53l0x_adjust1 Vl53l0x_data1;   //校准数据24c02读缓存区（用于系统初始化时向24C02读取数据）
_vl53l0x_adjust2 Vl53l0x_data2;   //校准数据24c02读缓存区（用于系统初始化时向24C02读取数据）
_vl53l0x_adjust3 Vl53l0x_data3;   //校准数据24c02读缓存区（用于系统初始化时向24C02读取数据）
_vl53l0x_adjust4 Vl53l0x_data4;   //校准数据24c02读缓存区（用于系统初始化时向24C02读取数据）
_vl53l0x_adjust5 Vl53l0x_data5;   //校准数据24c02读缓存区（用于系统初始化时向24C02读取数据）
...
xtalk:
    ...
    STMFLASH_Write(FLASH_SAVE_ADDR,(u16*)&Vl53l0x_adjust,sizeof(_vl53l0x_adjust));
