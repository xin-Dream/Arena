...
//#define FLASH_SAVE_ADDR  0X0800F500 	//设置FLASH 保存地址(必须为偶数，且其值要大于本代码所占用FLASH的大小+0X08000000)
#define VL53L0X_Addr 0x52

//控制Xshut电平,从而使能VL53L0X工作 1:使能 0:关闭
#define VL53L0X_Xshut PBout(14)
#define VL53L0X_Xshut1 PBout(15)
#define VL53L0X_Xshut2 PAout(8)
#define VL53L0X_Xshut3 PAout(9)
#define VL53L0X_Xshut4 PAout(10)
#define VL53L0X_Xshut5 PAout(11)
//#define VL53L0X_Xshut6 PAout(12)
//#define VL53L0X_Xshut7 PBout(15)
