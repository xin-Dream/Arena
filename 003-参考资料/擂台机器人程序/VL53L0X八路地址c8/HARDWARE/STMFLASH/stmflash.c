...
extern u16 flashdata[10];
extern student hetianfang;
//解锁STM32的FLASH
...
{
    STMFLASH_Read(FLASH_SAVE_ADDR,(u16*) &hetianfang,sizeof(hetianfang));
    if(hetianfang.age==0xff)
    {
        hetianfang.resettime=0;
        hetianfang.age=21;
        hetianfang.num=1505210117;
...
{
    STMFLASH_Write(FLASH_SAVE_ADDR,(u16*) &hetianfang,sizeof(hetianfang));
}
