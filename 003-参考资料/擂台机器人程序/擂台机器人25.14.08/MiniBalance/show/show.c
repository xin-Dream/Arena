...
//	len5=5000;len6=6000;len7=7000;len8=8000;
    ...
    OLED_ShowString(58-25,40,".");
//    OLED_ShowString(80-25,40,"V");
    OLED_ShowNumber(45-25,40,Voltage/100,2,12);
    OLED_ShowNumber(68-25,40,Voltage%100,2,12);
    if(Voltage%100<10) 	OLED_ShowNumber(62-25,40,0,2,12);
    //=============第五行显示角度=======================//
    OLED_ShowString(0+64,40,"YAW");
	OLED_ShowNumber(37+64,40,YAW/100,3,12);
	//=============第六行显示灰度=======================//
