...
#define Len_Front len1
#define Len_Back  len2
#define Len_Left  len3
#define Len_Right len4
#define Len_Upback len5
...
#define CM40 700 //实际测试距离值为40cm时 adc数值在750-900之间

extern int Encoder_Left,Encoder_Right;                     		 //左右编码器的脉冲计数
extern int PWML,PWMR;                                    		 //电机PWM变量 
...
extern u32 len1,len2,len3,len4,len5,len6,len7,len8;              //八个长度
extern u16 YAW,PITCH,ROLL;							             //航向，俯仰，横滚
