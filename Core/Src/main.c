...
void Encode_function(void const *argument);
...
int main(void) {
    ...
    /* definition and creation of Encode_Task */
    osThreadDef(Encode_Task, Encode_function, osPriorityAboveNormal, 0, 128);
    Encode_TaskHandle = osThreadCreate(osThread(Encode_Task), NULL);
...
/* USER CODE BEGIN Header_Encode_function */
/**
* @brief Function implementing the Encode_Task thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_Encode_function */
void Encode_function(void const *argument) {
    /* USER CODE BEGIN Encode_function */
    /* Infinite loop */
    for (;;) {
        osDelay(1);
    }
    /* USER CODE END Encode_function */
}
