...
echo_and_run cd "/home/dream/Projects/Arena/001-Program/Arena_ROS/src/rosserial/rosserial_client"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/dream/Projects/Arena/001-Program/Arena_ROS/src/rosserial/rosserial_client/setup.py" \
     \
    build --build-base "/home/dream/Projects/Arena/001-Program/Arena_ROS/build/rosserial/rosserial_client" \
    install \
    --root="${DESTDIR-/}" \
