...
//	HAL_GPIO_TogglePin(LED_GPIO_Port, LED_Pin);
    ...
    switch (uart1_params.receive_buff[0]) {
        case 0x31:
            motor.motion_flag = forward;
            break;
        case 0x32:
            motor.motion_flag = backward;
            break;
        case 0x33:
            motor.motion_flag = left;
            break;
        case 0x34:
            motor.motion_flag = right;
            break;
        case 0x35:
