...
void Perception_function(void const *argument);
...
/* USER CODE BEGIN Header_Perception_function */
/**
  * @brief  Function implementing the Perception_task thread.
  * @param  argument: Not used
  * @retval None
  */
/* USER CODE END Header_Perception_function */
void Perception_function(void const *argument) {
    /* USER CODE BEGIN 5 */
...
* @retval None
*/
/* USER CODE END Header_Decision_function */
void Decision_function(void const *argument) {
    /* USER CODE BEGIN Decision_function */
